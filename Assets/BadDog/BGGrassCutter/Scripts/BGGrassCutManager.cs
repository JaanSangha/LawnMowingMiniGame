...
namespace BadDog
{
    ...
    public class BGGrassCutManager : MonoBehaviour
    {
        ...
        //private grassArray : GrassInstance[];
        ...
        //private void Start()
        //{
        //   // grassArray = Terrain.activeTerrain.terrainData.treeInstances;
        //}
        ...
        public void CutGrassByCircle(int detailLayer, Vector3 position, Vector3 forward, float radius)
        {
            ...
            //FindObjectOfType<GameController>().SetGrassCountText(detailMap.Length);
